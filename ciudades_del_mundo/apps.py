...
class CiudadesDelMundoConfig(AppConfig):
    ...
    def ready(self):
        ...
        # Visual assets are URL-first. Do not auto-download Commons files on
        # startup; use `py manage.py ensure_visual_assets --repair-local-only`
        # only for explicit legacy local-file maintenance.
